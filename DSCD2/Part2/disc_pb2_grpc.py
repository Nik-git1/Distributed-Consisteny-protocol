...
class RegisterReplicaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.writeReplica = channel.unary_unary(
                '/disc.RegisterReplicaService/writeReplica',
                request_serializer=disc__pb2.write.SerializeToString,
        ...
        self.deleteReplica = channel.unary_unary(
                '/disc.RegisterReplicaService/deleteReplica',
                request_serializer=disc__pb2.uuidData.SerializeToString,
                response_deserializer=disc__pb2.result.FromString,
                )
...
def add_RegisterReplicaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'writeReplica': grpc.unary_unary_rpc_method_handler(
                    servicer.writeReplica,
                    request_deserializer=disc__pb2.write.FromString,
...
class RegisterReplicaService(object):
    ...
    def writeReplica(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/disc.RegisterReplicaService/writeReplica',
            disc__pb2.write.SerializeToString,
    ...
    def deleteReplica(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/disc.RegisterReplicaService/deleteReplica',
            disc__pb2.uuidData.SerializeToString,
            disc__pb2.result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
